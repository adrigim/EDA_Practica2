...
// TODO: Initializes the board, allocating the required space, and initializing also each square of it.
...
// TODO: Free the board's dynamically allocated resources.

/**
 * Pre:
 * Post:
 *
 * Frees the board's dynamically allocated resources.
 *
 * @param board The board to be cleaned up.
 */
